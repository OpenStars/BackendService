...
type TDataService interface {
  // Parameters:
  //  - Key
  GetTokenByPubkey(ctx context.Context, key string) (r *TDataResult_, err error)
  // Parameters:
  //  - Key
  GetPubkeyByToken(ctx context.Context, key string) (r *TDataResult_, err error)
  // Parameters:
  //  - Pubkey
  //  - Token
...
// Parameters:
//  - Key
func (p *TDataServiceClient) GetTokenByPubkey(ctx context.Context, key string) (r *TDataResult_, err error) {
...
// Parameters:
//  - Key
func (p *TDataServiceClient) GetPubkeyByToken(ctx context.Context, key string) (r *TDataResult_, err error) {
...
var retval *TDataResult_
  var err2 error
  if retval, err2 = p.handler.GetTokenByPubkey(ctx, args.Key); err2 != nil {
...
var retval *TDataResult_
  var err2 error
  if retval, err2 = p.handler.GetPubkeyByToken(ctx, args.Key); err2 != nil {
...
func (p *TDataServiceGetTokenByPubkeyArgs) GetKey() string {
  return p.Key
}
...
func (p *TDataServiceGetPubkeyByTokenArgs) GetKey() string {
  return p.Key
}
...
type TMapNotifyCallKVService interface {
TDataService
}

type TMapNotifyCallKVServiceClient struct {
  c thrift.TClient
  *TDataServiceClient
}

// Deprecated: Use NewTMapNotifyCallKVService instead
func NewTMapNotifyCallKVServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TMapNotifyCallKVServiceClient {
  return &TMapNotifyCallKVServiceClient{TDataServiceClient: NewTDataServiceClientFactory(t, f)}}

// Deprecated: Use NewTMapNotifyCallKVService instead
func NewTMapNotifyCallKVServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TMapNotifyCallKVServiceClient {
  return &TMapNotifyCallKVServiceClient{TDataServiceClient: NewTDataServiceClientProtocol(t, iprot, oprot)}
}

func NewTMapNotifyCallKVServiceClient(c thrift.TClient) *TMapNotifyCallKVServiceClient {
  return &TMapNotifyCallKVServiceClient{
    c: c,
    TDataServiceClient: NewTDataServiceClient(c),
  }
}

type TMapNotifyCallKVServiceProcessor struct {
  *TDataServiceProcessor
}

func NewTMapNotifyCallKVServiceProcessor(handler TMapNotifyCallKVService) *TMapNotifyCallKVServiceProcessor {
  self17 := &TMapNotifyCallKVServiceProcessor{NewTDataServiceProcessor(handler)}
  return self17
}
