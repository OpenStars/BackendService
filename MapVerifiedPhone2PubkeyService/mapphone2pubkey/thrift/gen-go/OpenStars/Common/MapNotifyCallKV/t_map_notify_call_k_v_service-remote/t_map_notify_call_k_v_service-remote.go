...
import (
        ...
        "OpenStars/Common/MapNotifyCallKV"
)
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  TDataResult getTokenByPubkey(string key)")
  fmt.Fprintln(os.Stderr, "  TDataResult getPubkeyByToken(string key)")
...
func main() {
  ...
  client := MapNotifyCallKV.NewTMapNotifyCallKVServiceClient(thrift.NewTStandardClient(iprot, oprot))
